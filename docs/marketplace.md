...
~/.omp/
  ...
  plugins/
    ...
    ohms-plugins.lock.json         # Runtime enable/feature state
...
<project>/.omp/
  plugins/
    ...
    ohms-plugins.lock.json         # Project runtime enable/feature state
    node_modules/<package>        # Symlink to the cached plugin
```
