#!/usr/bin/env bun
/**
 * OhMyShark release helper (downstream-owned, new file; not in the upstream graph).
 *
 ...
 *
 * Usage: bun scripts/ohms-fetch-natives.ts --tag <platform-tag,...> [--dest packages/natives/native]
 */
...
async function main(): Promise<void> {
	...
	const workDir = fs.mkdtempSync(path.join(REPO_ROOT, ".ohms-natives-"));
	try {
