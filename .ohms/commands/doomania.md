...
Dispatch exactly three parallel `task` subagents, one per persona, each given:
...
ultrathink orchestrate workflowz promaxthink
...
self-check before presenting anything (promaxthink/ultrathink), the full task
