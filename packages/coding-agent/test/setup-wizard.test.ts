...
import { SHARK_LOGO } from "@oh-my-pi/pi-coding-agent/modes/components/welcome";
...
describe("setup wizard short terminals", () => {
	...
	it("shows the shark art in a tall setup scene without changing frame bounds", async () => {
		await initTheme(false, "unicode", false, "titanium", "light");
