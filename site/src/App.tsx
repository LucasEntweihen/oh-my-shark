...
const COMMANDS: Record<OS, Record<Method, string[]>> = {
  mac: {
    verified: [
      ...
      "gh attestation verify install.sh --repo LucasEntweihen/oh-my-shark --signer-workflow LucasEntweihen/oh-my-shark/.github/workflows/release-ohms.yml --source-ref refs/tags/ohms-v0.0.3 --deny-self-hosted-runners",
      "sh install.sh",
    ],
  ...
  win: {
    verified: [
      ...
      "gh attestation verify install.ps1 --repo LucasEntweihen/oh-my-shark --signer-workflow LucasEntweihen/oh-my-shark/.github/workflows/release-ohms.yml --source-ref refs/tags/ohms-v0.0.3 --deny-self-hosted-runners",
...
export default function App() {
  ...
  useEffect(() => {
    applyTheme(theme);
    document.documentElement.dispatchEvent(new Event("ohms:theme"));
  }, [theme]);
            ...
            <section className="install" id="install" aria-labelledby="install-title">
              ...
              <div className="terminal">
                <div className="terminal-bar" aria-hidden="true">
                  ...
                  <span className="dot" />
                  <span className="dot" />
                  <span className="terminal-title">ohms — {t.installHeading.toLowerCase()}</span>
                </div>
